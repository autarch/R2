...
{
    my $provider = R2::Schema::MessagingProviderType->new(
        messaging_provider_type_id => 1,
...

{
    ...
    is(
        $provider->add_uri('bubba'),
        undef,
        'when a template needs a config value we do not have, we return undef'
    );
